...
Machine Learning Pipeline: Modular code for both Regression and Classification tasks, including hyperparameter tuning and model validation.
...
Inference & Experimentation: Probability distributions, Central Limit Theorem, and A/B Test design.

Supervised Learning - Regression: Simple/Multiple Linear Regression and Regularization techniques.

Supervised Learning - Classification: Logistic Regression, Naive Bayes, K-Nearest Neighbors (KNN), Support Vector Machines (SVM), and Decision Trees.
...
Algorithm Implementations: From scratch and library-based implementations of major ML models.
